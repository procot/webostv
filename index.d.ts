...
declare interface RequestParams<T> {
onSuccess: (result: T) => any;
onFailure: (error: RequestErrorObject) => any;
}

declare interface RequestErrorObject {
errorCode: string;
errorText: string;
}
...
declare interface GetConnectionStatusParameters extends RequestParams<ConnectionStatus> {
/**
 ...
 * and is the only value that is returned to the calling app.
 */
declare interface WifiDirectStatus {
/**
 * If the Wi-Fi connection is available it will be set to 'connected'.
 * If the Wi-Fi connection is not available, it will be set to 'disconnected'.
 */
 ...
 */
declare interface WifiPeerInfo {
/**
 * Device name.
 */
deviceName: string;
...
declare interface GetRightsErrorResponse {
/**
...
declare interface IsLoadedResponse {
/**
...
declare interface LoadResponse {
/**
...
declare interface SendDrmMessageParams extends RequestParams<SendDrmMessageResponse> {
/**
...
declare interface SendDrmMessageResponse {
/**
...
declare interface LaunchParameters extends RequestParams<void> {
/**
...
declare interface LGUDIDResponse {
/**
 * LG unique device ID.
 */
id: string;
...
declare interface ServiceRequestParams<T extends ObjectValue> extends RequestParams<T> {
/**
...
declare interface ServiceRequestReturn {
/**
